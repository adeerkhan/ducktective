...
import { SKILL_MD } from "@/lib/skill-doc";
...
function SkillPage() {
  ...
  return (
    <SiteShell>
      ...
      <h1 className="mt-2 font-display text-3xl tracking-tight">Drop it into the host you already run.</h1>
      <p className="mt-3 max-w-2xl text-sm leading-relaxed text-muted">
        Agent Skills standard. One folder, one <span className="text-fg">SKILL.md</span>. Works in Claude Code, Cursor,
        Copilot, Codex, Gemini CLI, and anything else that loads the spec. Ducktective is not a runtime.
      </p>
      ...
      <ol className="mt-10 grid gap-3 sm:grid-cols-3">
        <Step n="1" title="Make the folder" body="~/.claude/skills/ducktective/ or .agents/skills/ducktective/ in the repo." />
        <Step n="2" title="Paste SKILL.md" body="The file below is the entire skill. Scripts come later; the contract is the file." />
        <Step n="3" title="Invoke it" body="“Ducktective, investigate this failing test.” The host is forced through the loop." />
      </ol>
